...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
        ...
        .row  
          ...
          .col-lg-8.text-tema4-bloque1
            p Es el elemento que permite el desplazamiento descendente y ascendente de la válvula, para que ella cierre de forma centrada en su asiento. La válvula debe deslizarse dentro de la guía sin que esta última permita un juego axial, para que la válvula trabaje con exactitud y pueda realizar el sellado hermético en su asiento.
              br
              br
              | De modo que la válvula recibe no solamente la fuerza perpendicular que la impulsa hacia abajo, sino que también recibe fuerzas laterales ocasionadas por el empuje del mismo balancín, que debe transmitir el giro de la leva y con ello impulsar a la válvula respectiva.
    .row.fondo-tema1.mb-5
      .col-lg-12-mb-4
        .row
          .col-lg-3
          .col-lg-4
    ...
    .row.my-5.mb-5
      .col-lg-12
        p  Ahora bien, debido a que la fundición gris (hierro fundido) tiene un buen coeficiente de deslizamiento, se puede evitar la utilización de guías postizas; aunque este factor también permite la posibilidad de instalarlas en el caso de excesivo desgaste de este orificio básico original.
    .row.my-5.mb-5
      .col-lg-12-mb-4
        .row
          .col-lg-7.mb-5
            .row
              .col-lg-12
                .container-svg-5
                  .contanier-svg-5.d-none.d-lg-block
                    figure(data-aos="fade-right")
                      img(src="@/assets/curso/tema4/img1.svg" style=("width: 110px"))
                  .cont-text-5
                    p En los casos de culatas de aleaciones de aluminio, se requiere de una instalación de guías postizas, debido a que el material no soporta los esfuerzos de fricción como en el caso anterior. Para ello se deben utilizar guías de aleaciones de bronce, cobre o hierro fundido, materiales que sí reúnen buenas cualidades de resistencia a la temperatura y a la fricción.
              .row
                .col-lg-12.pt-3
                p Estas guías, al igual que los asientos de válvulas, deben ser introducidas con un ajuste en sus alojamientos, calentando previamente a la culata y enfriando a las guías; para que luego de insertarlas queden con el ajuste exacto dentro de su alojamiento. Debido al sentido de flujo de los gases de entrada, la guía de la válvula de admisión tiene un sector cónico en la parte baja, que permite un mejor ingreso de la mezcla y en el caso de las guías de las válvulas de escape esta reducción del diámetro y en sentido también cónico, posibilita la evacuación de los gases quemados sin brindar restricción a la salida de ellos.
          .col-lg-5
            figure(data-aos="fade-left")
              img(src='@/assets/curso/tema4/img3.png', alt='Texto que describa la imagen')
    .row.fondo-tema1.my-5.mb-5
      .col-lg-12-mb-4
        .row
          .col-lg-2
          .col-lg-4
    ...
    #t_4_1.titulo-segundo.color-acento-contenido
      h2 4.1 Comprobación de guía de las válvulas
        ...
        .row
          .col-lg-9.order-2.order-lg-1
            .row.mb-3
              ...
              .col-lg-4
                figure.img-tema4-bloque2
                  img(src='@/assets/curso/tema4/img5.png', alt='Texto que describa la imagen' style=("width: 370px"))
              .col-lg-8.text-tema4-bloque2
            ...
            .row
              .col-lg-12
                p Para ello se utilizará un reloj micrométrico con un palpador y del resultado de las medidas tomadas habrá que compararlas con la medición del vástago de la válvula, obteniendo con ello la holgura entre ellas, con la que se decidirá si rectificar la guía o reemplazarla por una nueva.
    ...
    .row.my-5.mb-5
      .bloque-texto-g.color-secundario.p-3.p-sm-4.p-md-5
        ...
        .bloque-texto-g__texto.p-4
          p.mb-0 En el caso de que el desgaste de la guía de válvula esté fuera de la tolerancia indicada por el fabricante, se podrá rectificar su pared interna; esto, para dejar la tolerancia justa con respecto al vástago de la válvula, pero solamente en el caso de que existan válvulas nuevas que dispongan de sobre medidas de recambio, ya que de no ser posible estar sobre medida, deberá ser reemplazada la guía y también la válvula, cuando esta última presente un desgaste excesivo.
            br
            br
    ...
    #t_4_3.titulo-segundo.color-acento-contenido
      h2 4.3 Válvulas de un motor de cuatro tiempos
    ...
    .row.my-5.mb-5
      .col-lg-12
        .row
          ...
          .col-lg-5
            figure(data-aos="fade-left")
              img(src='@/assets/curso/tema4/img9.png', alt='Imagen que presenta el diagrama de la guía de la válvula.')
    .row.fondo-tema1.my-5.mb-5
      .col-lg-12-mb-4
        .row
          .col-lg-3
        ...
        .row      
          ...
          .col-lg-8
            figure(data-aos="flip-right")
              img(src='@/assets/curso/tema4/img10.png', alt='Imagen que presenta cómo es una rima o escariador.')

    Separador
    <!-- BLOQUE 5 -->
    #t_4_4.titulo-segundo.color-acento-contenido
      h2 4.4 Diseño y construcción de las válvulas 

    .row.my-5.mb-5
      .col-lg-12  
        p Una válvula está constituida por dos partes fundamentales:
    .bg--img_03
      .row.justify-content-center.mb-4
        .col-lg-4
          figure(data-aos="fade-up")
            img(src="@/assets/curso/tema4/img11.png", alt="alt" style="width: 350px").img400.m-auto
        .col-lg-8
          AcordionA.mb-5(tipo="a" clase-tarjeta="tarjeta acordeonA")
            .row(titulo="El vástago")
              .col-12
                p.mb-0 El vástago es rectificado al “espejo”, teniendo un diámetro exacto para deslizarse dentro de la guía de válvula. Su superficie exterior tiene un tratamiento térmico para endurecerla, logrando soportar los esfuerzos a los que está expuesta.
                  br
                  br
                  | En su parte superior tiene diseñada una, dos o más ranuras, que sirven de alojamiento de los seguros cónicos de soporte del platillo del muelle. Sobre el final del vástago actúa el empuje que viene del eje de levas, transportado por el balancín o el propulsor, por lo que se hace necesario dar un tratamiento de endurecimiento en esta superficie para evitar su desgaste.
            .row(titulo="La cabeza de la válvula")
              .col-12
                p.mb-0 Es la norma que establece los criterios que permiten lograr eficazmente los requisitos del cliente La cabeza de la válvula en cambio, debe soportar esfuerzos de tracción, temperatura, presión y martilleo, razones suficientes para que se la fabrique de materiales muy resistentes. En la periferia de la cabeza se encuentra la superficie cónica de 45° o 60°, que realiza el cierre en el asiento de la culata.
    .row.my-5.mb-5
      .col-lg-12  
        p Ambas son soldadas a base de fusión a altas temperaturas, formando un solo cuerpo final.
    .row.fondo-tema1.my-5.mb-5
      .col-lg-12-mb-4
        .row
          .col-lg-3
    ...
    .row
      .col-lg-7.mb-5
        .row
          .col-lg-12
            .container-svg-6
              .contanier-svg-6.d-none.d-lg-block
                figure(data-aos="fade-right")
                  img(src="@/assets/curso/tema4/img2.svg" style=("width: 110px"))
              .cont-text-6
                 p La cabeza de la válvula se une al vástago de forma progresivamente redondeada, para formar una superficie de deslizamiento de los gases de entrada y salida. Esta superficie forma un radio de curvatura muy bien diseñada, que ayuda a transportar el movimiento del vástago hasta la cabeza. Adicionalmente, ofrece una buena superficie de apoyo, así como de direccionamiento del flujo de gases de entrada en las válvulas de admisión y de salida en el caso de las válvulas de escape.
                  br
                  br
                  | Una válvula está expuesta a muchos esfuerzos, entre ellos térmicos, esfuerzos que son compensados por el excelente material de construcción de acero con aleaciones de níquel, cromo y molibdeno.
      .col-lg-5
        figure(data-aos="fade-left")
    ...
    .row
      .col-lg-12.mt-1.mb-4
        .container-svg-7.my-4
          .contanier-svg-7.d-none.d-lg-block
            figure(data-aos="fade-right")
              img(src="@/assets/curso/tema3/img1.svg")
          .cont-text-7
            p El margen de la válvula determina el espesor mínimo luego de la rectificación de su asiento cónico.
 
    Separador
    <!-- BLOQUE 7 -->
    #t_4_6.titulo-segundo.color-acento-contenido
      h2 4.6 Válvulas con sodio (Na) dentro del vástago
    ...
    .row
      .col-lg-12.mt-1.mb-4
        .container-svg-8.my-4
          .contanier-svg-8.d-none.d-lg-block
            figure(data-aos="fade-right")
              img(src="@/assets/curso/tema3/img1.svg")
          .cont-text-8
            p <strong>PRECAUCIÓN:</strong> cuando se trabaja con válvulas rellenas de sodio, se debe tener la precaución de no cortarlas o esmerilarlas, ya que el sodio es un material muy inflamable al contacto con el agua y el aire.
    ...
    .row
      .col-lg-12.mt-1.mb-4
        .container-svg-9.my-4
          .contanier-svg-9.d-none.d-lg-block
            figure(data-aos="fade-right")
              img(src="@/assets/curso/tema3/img1.svg" style=("width: 85px"))
          .cont-text-9
            p Con estas medidas y las medidas interiores de la guía de válvula, se podrá determinar el juego u holgura entre la guía y el vástago de válvula. Otra operación importante que se debe realizar, es comprobar el asiento cónico de la cabeza de la válvula, rectificándola si fuera necesario y luego de esta rectificación será importante asentarla en el asiento de la culata utilizando la pasta de esmeril para obtener el sello hermético.
